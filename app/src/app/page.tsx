...
// We don't need marksChartConfig anymore since we use bare components
...
export default function Dashboard() {
  ...
  return (
    <main className="flex-1 overflow-y-auto bg-monolith-bg p-6 md:p-8 w-full block">
      {/* 
        Container wrapping all grid items correctly as per HTML spec:
        - LineChart spans 8, Stacked Chart spans 4 on Row 1 (total 12).
        - Logs spans 5, Calendar spans 4, Cloud spans 3 on Row 2 (total 12). 
      */}
          ...
          <div className="flex flex-col h-full relative">
            ...
            <div className="mt-6 border-b border-slate-700/60 pb-8">
               <div className="flex items-baseline gap-4">
                 {/* Calculating the total average for the selected standard dynamically */}
              ...
              <div className="flex gap-2 w-full mt-auto">
                {dummyPerformanceData[selectedStandard].map((subjectData) => (
                  <div key={subjectData.subject} className="flex flex-col" style={{ width: `${subjectData.average}%` }}>
                    {/* The segmented horizontal bar line directly translated from the image */}
